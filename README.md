...
Full Stack Engineer with 5+ years shipping production systems. I own products end-to-end — from database schema to checkout flow to deploy pipeline.

I built and operated an e-commerce platform that generated **US$90,000+ in sales**. Not a side project. A real business with real customers, real payments, and real uptime requirements.

Currently focused on React/Next.js frontends, Node.js backends, and e-commerce systems (Shopify, headless commerce, custom integrations).
...
Backend         Node.js · Express · REST APIs · GraphQL · Webhooks
Databases       PostgreSQL · MySQL · Prisma · Redis
E-commerce      Shopify (Liquid, Hydrogen, Storefront API) · Payment Gateways · CRO
Infrastructure  Vercel · Docker · GitHub Actions · CI/CD · AWS · Firebase
```
...
**Impact**
- **$90,000+** in total online sales
- **40%** faster page loads after frontend optimization
...
```
┌──────────────────────────────────────────────────────────┐
│  → Own it end-to-end. Architecture to production.        │
│  → Ship for impact, not for show.                        │
│  → Write code that survives the next feature.            │
